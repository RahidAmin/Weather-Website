// https://api.openweathermap.org/data/2.5/weather?q=dhaka&appid=ff2f5164c843ac5663fd0ea1ddfcd4cd
...
const Temperature = () => {
    ...
    const getWeatherInfo = async () => {
        try {
            let url = `https://api.openweathermap.org/data/2.5/weather?q=${searchValue}&units=metric&appid=ff2f5164c843ac5663fd0ea1ddfcd4cd`;
